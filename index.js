...
var paint = function () {
    setInterval(function () {
        ...
        var ballElement = createBall(positionBall, size, color);
        if (wrapper) {
...
function randomColor() {
    var stringSymbolsColor = "0123456789ABCDEF";
    var color = "#";
    for (var i = 0; i < 6; i++) {
